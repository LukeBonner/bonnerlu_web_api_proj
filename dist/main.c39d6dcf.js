...
thebutton === null || thebutton === void 0 ? void 0 : thebutton.addEventListener("click", function () {
  ...
  if (inputLen > 0) console.log("You entered", theInput === null || theInput === void 0 ? void 0 : theInput.value);else console.log("Please enter some text");
});
if (isNaN(breedLimit)) breedLimit = 10;
var catURL = "https://api.thecatapi.com/v1/breeds";
axios_1.default.get(catURL, {
  params: {
    limit: breedLimit
  }
}).then(function (r) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "11671" + '/');
